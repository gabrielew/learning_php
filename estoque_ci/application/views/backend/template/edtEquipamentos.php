...
<form method = "POST" action = "editarEQP_submit.php"> 
    ...
    Nome:<p></p>
    <input class="form-control" autofocus type = "text" name = "nome_equipamento" value="nome_equipamento"/> <p></p><p></p>
    Caixa:<p></p>
    ...
    <strong> Ocupado:</strong> <input class="form-control" type ="text" name="ocupado" value ="ocupado" readonly/><p></p>
