<?php
    ...
    class Equipamento {
        ...
        public function selectNAO(){
            
            $sql = "SELECT id_equipamento, nome_equipamento FROM equipamentos WHERE ocupado = 'NAO'";
        ...
        public function updateSIM($id_equipamento) {
            if($this->existIdEquipamento($id_equipamento)) {
                $sql = "UPDATE equipamentos SET ocupado = 'SIM' WHERE id_equipamento = :id_equipamento";
                $sql = $this->pdo->prepare($sql);
                $sql->bindValue(":id_equipamento", $id_equipamento);
                $sql->execute();
            }
        ...
        public function updateNAO($id_equipamento) {
            if($this->existIdEquipamento($id_equipamento)) {
                $sql = "UPDATE equipamentos SET ocupado = 'NAO' WHERE id_equipamento = :id_equipamento";
                $sql = $this->pdo->prepare($sql);
                $sql->bindValue(":id_equipamento", $id_equipamento);
                $sql->execute();
            }
